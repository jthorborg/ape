...
**************************************************************************************
	...
	file:IPlugSupport.cpp
	
		Rewrite of the original header to a source header. Allows proper use of definitions 
		multiple places instead of only once; this is why you should never put implementations
		in source files!
