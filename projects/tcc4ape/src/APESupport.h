	...
	struct CSharedInterface
	{
		...
		int			(APE_API * createPlot)		(CSharedInterface * iface, const char * name, const float * const values, const unsigned int numVals);
