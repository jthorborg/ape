	...
	namespace APE
	{
		...
		public:
			...
			public:
				...
				bool addFile(TCCState * s, const char * file) const { return bindings.addFile(s, file); }
				bool outputFile(TCCState * s, const char * ofile) const { return bindings.outputFile(s, ofile); }
